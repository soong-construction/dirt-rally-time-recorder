...
-- H1 FWD class
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (100, 'Mini Cooper S', 733.03826904296875, 83.77580261230469);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (101, 'DS Automobiles DS 21', 628.31854248046875, 104.71975708007812);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (102, 'Lancia Fulvia HF', 680.678466796875, 99.48377227783203);

-- H2 FWD class
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (200, 'Volkswagen Golf GTI 16V', 785.398193359375, 94.24777984619141);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (201, 'Peugeot 205 GTI', 733.03826904296875, 125.66371154785156);

-- H2 RWD class
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (300, 'Ford Escort Mk II', 994.8377075195312, 125.66371154785156);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (301, 'Renault Alpine A110 1600 S', 837.758056640625, 167.55160522460938);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (302, 'Fiat 131 Abarth Rally', 837.758056640625, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (303, 'Opel Kadett C GT/E', 942.477783203125, 157.07963562011719);

-- H3 RWD class
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (400, 'BMW E30 Evo Rally', 932.005859375, 115.19173431396484);
...
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (403, 'Renault 5 Turbo', 837.758056640625, 151.84365844726562);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (404, 'Datsun 240Z', 779.7432861328125, 80.42477416992188);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (405, 'Ford Sierra Cosworth RS500', 785.398193359375, 115.19173431396484);

-- Group B RWD
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (500, 'Lancia 037 Evo 2', 890.1179809570312, 125.66371154785156);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (501, 'Opel Manta 400', 816.81414794921875, 146.607666015625);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (502, 'BMW M1 Procar Rally', 968.6577758789062, 157.07963562011719);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (503, 'Porsche 911 SC RS', 837.758056640625, 136.13568115234375);

-- Group B 4WD
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (600, 'Audi Sport quattro S1 E2', 942.477783203125, 136.13568115234375);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (601, 'Peugeot 205 T16 Evo 2', 837.758056640625, 209.43951416015625);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (602, 'Lancia Delta S4', 890.1179809570312, 167.55160522460938);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (603, 'Ford RS200', 942.477783203125, 125.66371154785156);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (604, 'MG Metro 6R4', 994.8377075195312, 109.95574188232422);

-- R2
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (700, 'Ford Fiesta R2', 816.81414794921875, 157.07963562011719);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (701, 'Opel Adam R2', 905.825927734375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (702, 'Peugeot 208 R2', 890.1179809570312, 167.55160522460938);

-- Group A
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (800, 'Mitsubishi Lancer Evolution VI', 733.03826904296875, 146.607666015625);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (801, 'Subaru Impreza 1995', 733.03826904296875, 115.19173431396484);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (802, 'Lancia Delta HF Integrale', 785.398193359375, 104.71975708007812);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (803, 'Ford Escort RS Cosworth', 733.03826904296875, 146.607666015625);
...
-- NR4/R4
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (900, 'Subaru Impreza WRX STI NR4', 837.758056640625, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (901, 'Mitsubishi Lancer Evolution X', 785.398193359375, 178.02359008789062);

-- 4WD/2000cc
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1000, 'Citroen C4 Rally', 774.92620849609375, 188.49555969238281);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1001, 'Škoda Fabia Rally', 774.92620849609375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1002, 'Ford Focus RS Rally', 769.69024658203125, 186.92477416992188);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1003, 'Subaru Impreza 2008', 785.398193359375, 219.91148376464844);

-- R5
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1100, 'Ford Fiesta R5', 774.92620849609375, 188.49555969238281);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1101, 'Peugeot 208 T16 R5', 785.398193359375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1102, 'Mitsubishi Space Star R5', 837.758056640625, 219.91148376464844);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1103, 'Škoda Fabia R5', 774.92620849609375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1104, 'Volkswagen Polo GTI R5', 774.92620849609375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1105, 'Citroen C3 R5', 743.51031494140625, 185.87757873535156);

-- Rally GT 
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1200, 'Porsche 911 RGT Rally Spec', 942.477783203125, 188.4955596923828);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1201, 'BMW M2 Competition', 733.03826904296875, 146.607666015625);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1202, 'Chevrolet Camaro GT4.R', 759.21820068359375, 178.02359008789062);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1203, 'Aston Martin V8 Vantage GT4', 733.03826904296875, 104.71975708007812);
INSERT INTO cars (id, name, maxrpm, startrpm) VALUES (1204, 'Ford Mustang GT4 Ford RS200', 863.9380493164062, 146.607666015625);
